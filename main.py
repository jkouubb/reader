...
if __name__ == '__main__':
    ...
    yolo_manager = yolo.YOLOManager(param_path='yolo_param', train_epoch=100, learn_rate=1e-4, class_number=2, small_anchors=[[25, 25], [29, 28], [34, 32]], middle_anchors=[[63, 59], [74, 59], [67, 68]], large_anchors=[[75, 67], [79, 73], [86, 67]])

    judger_manager = judger.JudgerManager(param_path='judger_param', train_epoch=50, learn_rate=1e-4)
